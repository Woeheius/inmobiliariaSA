...
<head>
    ...
    <title>Registrar Agente - Inmobiliaria S.A.</title>
...
<div class="container">
    <h2 class="text-primary mb-4">Registrar Nuevo Agente</h2>
    <form action="AgenteController?action=agregar" method="post">
        ...
        <button type="submit" class="btn btn-primary btn-block">Registrar Agente</button>
    </form>
</div>
