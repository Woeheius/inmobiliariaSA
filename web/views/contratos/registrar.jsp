                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="invalid-feedback">
                                Por favor ingrese el código del contrato.
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="codigoInmueble" name="codigoInmueble" required>
                                ...
                                <c:forEach var="inmueble" items="${listaInmuebles}">
                                    <option value="${inmueble.codigo}">${inmueble.descripcion} - ${inmueble.direccion}</option>
                                </c:forEach>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="cedulaCliente" name="cedulaCliente" required>
                                ...
                                <c:forEach var="cliente" items="${listaClientes}">
                                    <option value="${cliente.cedula}">${cliente.nombreCompleto} - ${cliente.cedula}</option>
                                </c:forEach>
                            </select>
                            <div class="invalid-feedback">
