...
<head>
    ...
    <title>Editar Propietario - Inmobiliaria S.A.</title>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="fas fa-edit"></i> Editar Propietario</h4>
                </div>
                <div class="card-body">
                    <form action="PropietarioController?action=actualizar" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="cedula" name="cedula" value="${propietario.cedula}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="nombreCompleto" class="form-label">Nombre Completo:</label>
                                <input type="text" class="form-control" id="nombreCompleto" name="nombreCompleto" value="${propietario.nombreCompleto}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento" value="${propietario.fechaNacimiento}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="fechaExpedicion" class="form-label">Fecha de Expedición:</label>
                                <input type="date" class="form-control" id="fechaExpedicion" name="fechaExpedicion" value="${propietario.fechaExpedicion}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="numeroContacto1" name="numeroContacto1" value="${propietario.numeroContacto1}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="numeroContacto2" class="form-label">Número de Contacto 2:</label>
                                <input type="text" class="form-control" id="numeroContacto2" name="numeroContacto2" value="${propietario.numeroContacto2}">
                            </div>
                        </div>
